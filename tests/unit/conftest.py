...
def mock_streamlit_cache():
    ...
    with patch('streamlit.cache_data', mock_cache_decorator), \
         patch('streamlit.cache_resource', mock_cache_decorator):
        yield
...
class AcademicTestCase:
    ...
    def assert_confidence_level(self, confidence, minimum_threshold=0.5):
        ...
        if confidence is not None:
            ...
            assert confidence >= minimum_threshold, \
