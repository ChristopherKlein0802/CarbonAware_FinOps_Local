...
from ..models.dashboard import TimeSeriesPoint
from ..constants import AcademicConstants
from ..infrastructure.cache import FileCacheRepository
from ..infrastructure.time_series import JsonTimeSeriesStore
...
class CarbonDataService:
    ...
    def __init__(
        ...
        *,
        ...
        self._time_series_store = time_series_store or JsonTimeSeriesStore(
            repository, self.config.timeseries_cache_key
        )
    ...
    def build_time_series(
        ...
        if not hourly_costs:
            ...
            return self.get_cached_time_series(), None, None
        ...
        avg_carbon_intensity = (
            sum(aligned_carbon_values) / len(aligned_carbon_values)
