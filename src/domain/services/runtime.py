...
from src.domain.calculations import calculate_simple_power_consumption, calculate_co2_emissions
    ...
    def enrich_instance(
        ...
        *,
        ...
        if effective_power_watts is not None and runtime_hours is not None:
            monthly_co2_kg = calculate_co2_emissions(effective_power_watts, carbon_intensity, runtime_hours)
